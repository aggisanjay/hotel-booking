...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>UnParalleled luxury and comfort await at the world's most exculsive hotels and resorts. Start your jounery today.</p>
...
<div>
    ...
    <input value={destination} onChange={(e)=>setDestination(e.target.value)} list='destinations' id="destinationInput" type="text" className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none" placeholder="Type here" required />
