...
const [rooms, setRooms] = useState(roomsDummyData);
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed roms. leep the information up-to-date to provide the best experience for users.' />
      ...
      <table className='w-full'>
        <thead className='bg-gray-50'>
            <tr>
                ...
                <th className='py-3 px-4 text-gray-800 font-medium'>Price / night
                </th>
